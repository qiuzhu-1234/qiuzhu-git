...
public class JsonUtil {
    ...
    public static String getString(Map<String,Object> jsonObject, String fieldName){
        return jsonObject.get(fieldName)==null ? null : jsonObject.get(fieldName).toString();
    }

    public static Integer getInteger(Map<String,Object> jsonObject, String fieldName){
        return jsonObject.get(fieldName)==null ? null : Integer.parseInt(jsonObject.get(fieldName).toString());
    }
