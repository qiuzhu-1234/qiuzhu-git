...
import com.whbt.hrms.service.YuangongpeixunService;
...
public class YuangongpeixunController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YuangongpeixunEntity yuangongpeixun,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yuangong")) {
			yuangongpeixun.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YuangongpeixunEntity yuangongpeixun, 
		HttpServletRequest request){
        EntityWrapper<YuangongpeixunEntity> ew = new EntityWrapper<YuangongpeixunEntity>();
		PageUtils page = yuangongpeixunService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuangongpeixun), params), params));
        return R.ok().put("data", page);
